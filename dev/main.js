...
function init() {
  Promise.all([d3.dsv(",", "assets/data/ranking.csv", function (d) {
    ...
    var labelPadding = 8; // the component used to render each label
    ...
    var strategy = (0, _d3fcLabelLayout.layoutAnnealing)(); // create the layout that positions the labels
    ...
    scatterOverallSvg.datum(pointsMean).call(labels); //d3.selectAll("g.label text").attr("dy", "-0.9em")
...
exports.default = _default;
},{"flubber":"yVOz","nouislider":"p3wi","d3fc-label-layout":"LUlz"}],"v9Q8":[function(require,module,exports) {
"use strict";
